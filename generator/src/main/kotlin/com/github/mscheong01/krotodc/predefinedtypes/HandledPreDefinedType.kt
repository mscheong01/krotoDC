...
package com.github.mscheong01.krotodc.predefinedtypes
...
enum class HandledPreDefinedType(
    ...
    TIMESTAMP(
        ...
        TransformTemplateWithImports.of(
            "%L.toLocalDateTime()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toLocalDateTime")))
        ),
        TransformTemplateWithImports.of(
            "%L.toProtoTimestamp()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toProtoTimestamp")))
        )
    ),
    DURATION(
        ...
        TransformTemplateWithImports.of(
            "%L.toDuration()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toDuration")))
        ),
        TransformTemplateWithImports.of(
            "%L.toProtoDuration()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toProtoDuration")))
        )
    ),
    ...
    DOUBLE_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toDoubleValue()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toDoubleValue")))
        )
    ),
    FLOAT_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toFloatValue()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toFloatValue")))
        )
    ),
    INT64_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toInt64Value()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toInt64Value")))
        )
    ),
    UINT64_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toUInt64Value()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toUInt64Value")))
        )
    ),
    INT32_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toInt32Value()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toInt32Value")))
        )
    ),
    UINT32_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toUInt32Value()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toUInt32Value")))
        )
    ),
    BOOL_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toBoolValue()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toBoolValue")))
        )
    ),
    STRING_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toStringValue()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toStringValue")))
        )
    ),
    BYTES_VALUE(
        ...
        TransformTemplateWithImports.of(
            "%L.toBytesValue()",
            setOf(Import("com.github.mscheong01.krotodc", listOf("toBytesValue")))
        )
    )
    ;
