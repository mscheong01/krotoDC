...
import com.github.mscheong01.wellknowntypes.krotodc.mapemptymessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.mapemptymessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.mapstructanymessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.mapstructanymessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.maptimemessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.maptimemessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.mapwrappermessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.mapwrappermessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.messagewithempty.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.messagewithempty.toProto
import com.github.mscheong01.wellknowntypes.krotodc.repeatedemptymessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.repeatedemptymessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.repeatedstructanymessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.repeatedstructanymessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.repeatedtimemessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.repeatedtimemessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.repeatedwrappermessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.repeatedwrappermessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.structanymessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.structanymessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.timemessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.timemessage.toProto
import com.github.mscheong01.wellknowntypes.krotodc.wrappermessage.toDataClass
import com.github.mscheong01.wellknowntypes.krotodc.wrappermessage.toProto
...
class WellKnownTypesTest {
    ...
    fun `test mesasge with Empty`() {
        ...
        Assertions.assertThat(kroto).isEqualTo(com.github.mscheong01.wellknowntypes.krotodc.MessageWithEmpty(Unit))
    ...
    fun `test message with time types`() {
        val kroto = com.github.mscheong01.wellknowntypes.krotodc.TimeMessage(
    ...
    fun `test message with well known wrapper fields`() {
        ...
        Assertions.assertThat(kroto).isEqualTo(
            com.github.mscheong01.wellknowntypes.krotodc.WrapperMessage(
                1.0,
                2.0f,
                3,
                4,
