...
import com.github.mscheong01.importtest.ImportFromOtherFileTest.ImportTestMessage
import com.github.mscheong01.importtest.krotodc.importtestmessage.toDataClass
import com.github.mscheong01.importtest.krotodc.importtestmessage.toProto
...
import com.github.mscheong01.test.krotodc.deprecatedmessage.toDataClass
import com.github.mscheong01.test.krotodc.employee.toDataClass
import com.github.mscheong01.test.krotodc.employee.toProto
import com.github.mscheong01.test.krotodc.emptymessage.toDataClass
import com.github.mscheong01.test.krotodc.emptymessage.toProto
import com.github.mscheong01.test.krotodc.mapmessage.toDataClass
import com.github.mscheong01.test.krotodc.mapmessage.toProto
import com.github.mscheong01.test.krotodc.oneofmessage.toDataClass
import com.github.mscheong01.test.krotodc.oneofmessage.toProto
import com.github.mscheong01.test.krotodc.optionalmessage.toDataClass
import com.github.mscheong01.test.krotodc.optionalmessage.toProto
import com.github.mscheong01.test.krotodc.person.toDataClass
import com.github.mscheong01.test.krotodc.person.toProto
import com.github.mscheong01.test.krotodc.primitivemessage.toDataClass
import com.github.mscheong01.test.krotodc.primitivemessage.toProto
import com.github.mscheong01.test.krotodc.repeatedmessage.toDataClass
import com.github.mscheong01.test.krotodc.repeatedmessage.toProto
...
class ConversionTest {
    ...
    fun `test message with repeated fields`() {
        ...
        Assertions.assertThat(kroto.repeatedPerson).containsExactly(
            com.github.mscheong01.test.krotodc.Person(name = "John", age = 30),
            com.github.mscheong01.test.krotodc.Person(name = "Jane", age = 25)
        )
        val proto2 = kroto.toProto()
    ...
    fun `test message with map fields`() {
        ...
        Assertions.assertThat(kroto.mapStringPerson).contains(
            entry("5", com.github.mscheong01.test.krotodc.Person(name = "John", age = 30))
        )
    ...
    fun `test message with oneof fields`() {
        ...
        Assertions.assertThat(kroto.oneofField)
            .isInstanceOf(com.github.mscheong01.test.krotodc.OneOfMessage.OneofField.OneofPerson::class.java)
        Assertions.assertThat(
            kroto.oneofField as com.github.mscheong01.test.krotodc.OneOfMessage.OneofField.OneofPerson
        )
            .isEqualTo(
                com.github.mscheong01.test.krotodc.OneOfMessage.OneofField.OneofPerson(
                    com.github.mscheong01.test.krotodc.Person(name = "John", age = 30)
                )
            )
        ...
        Assertions.assertThat(kroto2.oneofField)
            .isInstanceOf(com.github.mscheong01.test.krotodc.OneOfMessage.OneofField.OneofString::class.java)
        Assertions.assertThat(
            kroto2.oneofField as com.github.mscheong01.test.krotodc.OneOfMessage.OneofField.OneofString
        )
            .isEqualTo(com.github.mscheong01.test.krotodc.OneOfMessage.OneofField.OneofString("1"))
    ...
    fun `test message with imported type field`() {
        ...
        Assertions.assertThat(kroto.importedNestedMessage).isEqualTo(
            com.github.mscheong01.test.krotodc.TopLevelMessage.NestedMessage(name = "test")
        )
